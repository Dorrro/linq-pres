...
namespace LINQ
{
    internal class Program
    {
        ...
        {
            new ExtensionMethodsInAction().DoIt();
            new LambdaExpressionsHistory().DoIt();
            new ExecutingLambdas().DoIt();
            new LinqInAction().DoIt();
            new LinqExamples().DoIt();
            new CreatingOurOwnLinq().DoIt();
            new DangerousLinq().DoIt();
        }
    }

    internal class DangerousLinq
    {
        public void DoIt()
        {
